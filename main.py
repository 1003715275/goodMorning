...
def get_weather():
  ...
  return  weather['weather'], math.floor(weather['low']), math.floor(weather['high']), math.floor(weather['temp']), weather['wind'], weather['airQuality']
...
wea, low, high, temperature, wind, airquality = get_weather()
...
# data = {"things5":{"value":city, "color":get_random_color()},"time12":{"value":today, "color":get_random_color()},"thing13":{"value":city, "color":get_random_color()},"pharse2":{"value":city, "color":get_random_color()},"pharse3":{"value":wea, "color":get_random_color()}}
